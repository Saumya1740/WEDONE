...
import com.example.wedone.databinding.ActivityJewelleryBinding;
...
public class jewellery extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        AlertDialog.Builder builder = new AlertDialog.Builder(jewellery.this);
    ...
    public void Opencategory(View view) {
        startActivity(new Intent(jewellery.this,category.class));
