...
import com.example.wedone.databinding.ActivityFoodBinding;
...
public class food extends AppCompatActivity implements View.OnClickListener {
    ...
    public void Opencategory(View view) {
        startActivity(new Intent(food.this,category.class));

    }

    public void Openvendorpage(View view) {
        startActivity(new Intent(food.this,VendorPage.class));
